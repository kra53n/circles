...
func printUsage() {
	...
	fmt.Println("4) 1 эвристика (сколько кругов не на свёом месте))")
	fmt.Println("5) 2 эвристика (манхэттенское расстояние)")
	fmt.Println("6) эвристика на основе подзадач без 2 эвристики")
	fmt.Println("7) эвристика на основе подзадач с 2 эвристикой")
